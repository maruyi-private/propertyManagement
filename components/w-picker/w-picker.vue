		...
		<view class="w-picker-cnt" :class="{'show':showPicker}">
			...
			<view class="w-picker-view" v-if="mode=='limit'">
				<picker-view :indicator-style="itemHeight" :value="pickVal" @change="bindChange">
					...
					<!-- <picker-view-column>
						<view class="item" v-for="(item,index) in data.hours" :key="index">{{item.label}}:00 - </view>
					</picker-view-column> -->
					<picker-view-column>
						<!-- <view class="item" v-for="(item,index) in data.hours" :key="index">{{item.label}}:00 - </view> -->
						<view class="item" v-for="(item,index) in data.hours" :key="index">{{item.label}}:00 - {{ parseInt(item.label) + 2 }}:00</view>
					</picker-view-column>
				</picker-view>
			</view>
		</view>
